...
var charts = {
  // 按顺序排列从大到小
  cityList: ['保安企业数', '保安人数', '党员人数', '持证人数', '行业规模'],
...
export function chartOptionAnalysiscc() {
  return {
    grid: [
      {
        // 左侧的柱状图grid
...
export function chartOptionManageBarCondition() {
  return {
    grid: [
      {
        // 左侧的柱状图grid
        ...
        itemStyle: {
          normal: {
            color: new echarts.graphic.LinearGradient(
              ...
              1,
              0,
              ['rgba(253, 191, 125, 0.2)', 'rgba(253, 191, 125, 1)'].map(
                (color, offset) => ({
                  color,
                  offset
                })
